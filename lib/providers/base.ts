...
export abstract class BaseProvider implements AIProvider {
  ...
  abstract listSessions(filter?: import('@/types').SessionFilter): Promise<import('@/types').Session[]>;
  abstract getSession(id: string): Promise<import('@/types').SessionDetail>;
  abstract watchSessions(callback: (event: import('@/types').SessionEvent) => void): import('@/types').Disposable;
  ...
  abstract launchSession(config: import('@/types').LaunchConfig): Promise<import('@/types').ProcessHandle>;
}
