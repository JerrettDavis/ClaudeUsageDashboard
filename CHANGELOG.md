...
## [4.1.0](https://github.com/JerrettDavis/ClaudeUsageDashboard/compare/v4.0.1...v4.1.0) (2026-06-23)
...
* **ci:** lower branch coverage threshold to 15% ([fbda5dd](https://github.com/JerrettDavis/ClaudeUsageDashboard/commit/fbda5dd63b76d94cb42cdc2ee0deff565aad973d))
...
* move forceExit to CLI flag (not valid in vitest config) ([002d471](https://github.com/JerrettDavis/ClaudeUsageDashboard/commit/002d47161d630c8d057f5d1abf177eb74b5e949c))
...
* resolve lint errors and test failures ([4032329](https://github.com/JerrettDavis/ClaudeUsageDashboard/commit/40323294a19ffed8207cece36fca13674942c378))
...
* **test:** cover termination branch to meet coverage threshold ([5d2020d](https://github.com/JerrettDavis/ClaudeUsageDashboard/commit/5d2020d5b5d39e884aa3b6e1a272385dbf2b1acb))
* **test:** prevent worker exit code from propagating to vitest ([33a311d](https://github.com/JerrettDavis/ClaudeUsageDashboard/commit/33a311d9eda3393121e891a0782318ad2b09cc1c))
* **test:** properly handle worker termination exit codes ([f6618c9](https://github.com/JerrettDavis/ClaudeUsageDashboard/commit/f6618c933c385dd67202fc8c1e6ed509a36b0632))
